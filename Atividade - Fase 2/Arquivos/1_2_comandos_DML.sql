...
de um desempenho ágil, porém silencioso, com processadores Intel Core de até 12 geração combinados com SSD PCIe.');
INSERT INTO MC_PRODUTO (CD_CATEGORIA, NR_CD_BARRAS_PROD, DS_PRODUTO, VL_UNITARIO, TP_EMBALAGEM, ST_PRODUTO, VL_PERC_LUCRO, DS_COMPLETA_PROD) VALUES
...
INSERT INTO MC_PRODUTO (CD_CATEGORIA, NR_CD_BARRAS_PROD, DS_PRODUTO, VL_UNITARIO, TP_EMBALAGEM, ST_PRODUTO, VL_PERC_LUCRO, DS_COMPLETA_PROD) VALUES
(2, 'A2249127102841', 'Raquete de tenis Wilson Aggressor', 279.00, 'Média', 'A', 0.30,
'Wilson Raquete de tênis Aggressor 112 para jogadores com um estilo de jogo agressivo, raquete extra longa para mais alcance');
INSERT INTO MC_PRODUTO (CD_CATEGORIA, NR_CD_BARRAS_PROD, DS_PRODUTO, VL_UNITARIO, TP_EMBALAGEM, ST_PRODUTO, VL_PERC_LUCRO, DS_COMPLETA_PROD) VALUES
(3, 'A2249127102841', 'Whiskas Sache para gatos adultos', 29.00, 'Pequena', 'A', 0.30, 'Ração úmida para gatos adultos, sabor frango');
INSERT INTO MC_PRODUTO (CD_CATEGORIA, NR_CD_BARRAS_PROD, DS_PRODUTO, VL_UNITARIO, TP_EMBALAGEM, ST_PRODUTO, VL_PERC_LUCRO, DS_COMPLETA_PROD) VALUES
(3, 'A2249127102841', 'Rasqueadeira Autolimpante', 59.00, 'Pequena', 'A', 0.25,
'SAÚDE E BEM-ESTAR DO ANIMAL: Auxilia na prevenção de bolas de pelos em gatos e promove a transpiração saudável em cães, adaptando-se a mudanças climáticas.');
...
INSERT INTO MC_SGV_VISUALIZACAO_VIDEO (CD_VISUALIZACAO_VIDEO, NR_CLIENTE, CD_PRODUTO, NR_SEQUENCIA,
DT_VISUALIZACAO, NR_HORA_VISUALIZACAO, NR_MINUTO_VIDEO, NR_SEGUNDO_VIDEO) VALUES
...
SET DS_CARGO = 'Especialista em Atendimnto',
...
-- ST_PRODUTO aceitaria apenas os valores I (Inativo) e A (Ativo). Assim, qualquer outro valor diferente dos definidos não serão aceitos.
